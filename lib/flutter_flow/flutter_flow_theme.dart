...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF080888);
  late Color secondary = const Color(0xFF68D8E8);
  late Color tertiary = const Color(0xFF6048C0);
  late Color alternate = const Color(0xFFD8E0E0);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF888888);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF010440);
  late Color accent2 = const Color(0x4D36B4FF);
  late Color accent3 = const Color(0xFF29166F);
  late Color accent4 = const Color(0xFF8B8B8E);
  late Color success = const Color(0xFF16B070);
  late Color warning = const Color(0xFFCC8E30);
  late Color error = const Color(0xFFB22761);
