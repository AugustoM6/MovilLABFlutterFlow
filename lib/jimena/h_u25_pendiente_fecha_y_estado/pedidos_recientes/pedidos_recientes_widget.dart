...
class _PedidosRecientesWidgetState extends State<PedidosRecientesWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<PedidosRecord>>(
      future: queryPedidosRecordOnce(),
      builder: (context, snapshot) {
        ...
        List<PedidosRecord> pedidosRecientesPedidosRecordList = snapshot.data!;
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  final itemsFiltrados = functions
                                      .getListaPedidos(
                                          0,
                                          4,
                                          pedidosRecientesPedidosRecordList
                                              .map((e) => e.reference)
                                              .toList())
                                      .toList();
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (functions
                            ...
                            functions
                                .numeroPagina(
                                    pedidosRecientesPedidosRecordList.length,
                                    _model.paginas)
                                .toString())
                          FlutterFlowIconButton(
                            borderColor: Colors.transparent,
