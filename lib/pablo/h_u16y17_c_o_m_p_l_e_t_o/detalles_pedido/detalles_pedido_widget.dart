...
class _DetallesPedidoWidgetState extends State<DetallesPedidoWidget> {
  ...
  void initState() {
    ...
    _model.txtFdFechaTextController ??=
        TextEditingController(text: widget.paramPedidos?.fecha?.toString());
    _model.txtFdFechaFocusNode ??= FocusNode();
                            ...
                            children: [
                              Expanded(
                                child: SizedBox(
                                  width: 200.0,
                                  child: TextFormField(
                                    controller: _model.txtFdFechaTextController,
                                    focusNode: _model.txtFdFechaFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      isDense: true,
                                    ...
                                    cursorColor: FlutterFlowTheme.of(context)
                                        .primaryText,
                                    validator: _model
                                        .txtFdFechaTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
