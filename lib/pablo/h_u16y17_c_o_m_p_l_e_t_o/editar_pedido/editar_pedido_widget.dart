...
class EditarPedidoWidget extends StatefulWidget {
  const EditarPedidoWidget({
    super.key,
    required this.paramPedidos,
  });

  final PedidosRecord? paramPedidos;
...
class _EditarPedidoWidgetState extends State<EditarPedidoWidget> {
  ...
  void initState() {
    ...
    _model.txtFdNombreTextController ??=
        TextEditingController(text: widget.paramPedidos?.nombre);
    _model.txtFdNombreFocusNode ??= FocusNode();

    _model.txtFdTecnicoTextController ??=
        TextEditingController(text: widget.paramPedidos?.tecnicoACargo);
    _model.txtFdTecnicoFocusNode ??= FocusNode();

    _model.txtFdEstadoTextController ??=
        TextEditingController(text: widget.paramPedidos?.estado);
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'ybm8hzka' /* FECHA DE SOLICITUD DEL PEDIDO: */,
                                  ),
                        ...
                        FlutterFlowCalendar(
                          ...
                          initialDate: widget.paramPedidos?.fecha,
                          rowHeight: 48.0,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await widget.paramPedidos!.reference
                                      .update(createPedidosRecordData(
                                    nombre:
                                        _model.txtFdNombreTextController.text,
                                    fecha: _model.calendarSelectedDay?.start,
                                    tecnicoACargo:
                                        _model.txtFdTecnicoTextController.text,
                                    estado:
