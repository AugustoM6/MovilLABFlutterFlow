...
class IndexProductoWidget extends StatefulWidget {
  const IndexProductoWidget({super.key});

  @override
  State<IndexProductoWidget> createState() => _IndexProductoWidgetState();
}

class _IndexProductoWidgetState extends State<IndexProductoWidget> {
  late IndexProductoModel _model;
