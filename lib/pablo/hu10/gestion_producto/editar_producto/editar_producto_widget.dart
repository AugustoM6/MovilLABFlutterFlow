...
class EditarProductoWidget extends StatefulWidget {
  const EditarProductoWidget({
    super.key,
    required this.paramProductos,
  });

  final ProductoRecord? paramProductos;
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model
                                .txtFdDescripTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor:
                                FlutterFlowTheme.of(context).primaryText,
                            validator: _model
                                .txtFdDepartamTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
