...
class DetallesEmpleadoWidget extends StatefulWidget {
  const DetallesEmpleadoWidget({
    super.key,
    required this.paramEmpleados,
  });

  final EmpleadosRecord? paramEmpleados;

  @override
  State<DetallesEmpleadoWidget> createState() => _DetallesEmpleadoWidgetState();
}

class _DetallesEmpleadoWidgetState extends State<DetallesEmpleadoWidget> {
  late DetallesEmpleadoModel _model;
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.txtDepartamentoTextController,
                                focusNode: _model.txtDepartamentoFocusNode,
                                autofocus: false,
                                readOnly: true,
                                obscureText: false,
                                decoration: InputDecoration(
                        ...
                        children: [
                          Expanded(
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.txtFechaContratTextController,
                                focusNode: _model.txtFechaContratFocusNode,
                                autofocus: false,
                                readOnly: true,
                                obscureText: false,
                                decoration: InputDecoration(
