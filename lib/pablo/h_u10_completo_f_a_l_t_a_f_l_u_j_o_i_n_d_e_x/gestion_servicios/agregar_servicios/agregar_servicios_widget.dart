...
class _AgregarServiciosWidgetState extends State<AgregarServiciosWidget> {
  ...
  void initState() {
    ...
    _model.txtFdPrecioTextController ??= TextEditingController();
    _model.txtFdPrecioFocusNode ??= FocusNode();

    _model.txtFdEmpleadoTextController ??= TextEditingController();
                                ...
                                onPressed: () async {
                                  await ServiciosRecord.collection
                                      ...
                                      .set(createServiciosRecordData(
                                        ...
                                        descripcion: _model
                                            .txtFdDescripTextController.text,
                                        precio: int.tryParse(_model
                                            .txtFdPrecioTextController.text),
                                        empleadoId: _model
                                            .txtFdEmpleadoTextController.text,
                                        estado: /* NOT RECOMMENDED */ _model
                                                .txtFdEmpleadoTextController
                                                .text ==
                                            'true',
                                      ));
