...
class ContactenosWidget extends StatefulWidget {
  const ContactenosWidget({super.key});
                ...
                Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'gtk7xkez' /* Visítanos en Esencia Dental Co... */,
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                              letterSpacing: 0.0,
                ...
                Align(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'tttnru7u' /* Síguenos en Instagram - Esenci... */,
                        ),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                              letterSpacing: 0.0,
